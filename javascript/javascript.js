...
// function slide(n) {
//     let i;
//     let slides =document.getElementsByClassName("rev_box");
//     let dots = document.getElementsByClassName("dot");
//     if (n > slides.length) {idx=1}
//     if (n < 1) {idx=slides.length}
//     for (i=0; i < slides.length; i++){
//         sldies[i].style.display = "none";

//     }
//     for (i=0; i < dots.length; i++;){
//         dots[i].className = dots[i].className.replace("active","");
//     }
//     sldies[idx-1].style.display = "block";
...
// var sli = document.querySelector('#rev_sldie');
// var slid = document.querySelectorAll('#rev_sldie .rev_box');
// var box = document.querySelector('.rev_box');
// var idx = 0;
// var cou = slid.length;

// function mov(num) {
//     sli.style.left = `${-num * box.offsetWidth}px`;
//     idx = num;
